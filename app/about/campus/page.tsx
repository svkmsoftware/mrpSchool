  ...
  const facilities = [
    {
      ...
      icon: <Landmark />,
      desc: "Modern classrooms with integrated smart technology.",
    },
    {
      title: "Hydro Harvester",
      icon: <Wind />,
      desc: "Innovative system producing 1000L of potable water from air daily.",
    },
    {
      title: "24/7 Security",
      icon: <Shield />,
      desc: "Fully covered campus with round-the-clock CCTV surveillance.",
    },
    {
      title: "Water Harvesting",
      icon: <Droplets />,
      desc: "Advanced systems saving thousands of liters annually.",
    },
  ];
    ...
    <main className="bg-white">
      <section className="relative pt-24 pb-32 overflow-hidden bg-slate-900 text-white">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <span className="text-primary font-black uppercase tracking-[0.4em] text-xs mb-6 block">
            The Infrastructure
          </span>
          ...
          <p className="max-w-2xl text-slate-400 text-lg leading-relaxed">
            Nestled in the serene outskirts of Shirpur, our campus is a blend of
            modern architecture and sustainable living, designed to inspire
            learning and growth.
          </p>
        </div>
        <Trees
          className="absolute right-[-5%] bottom-[-10%] text-white/5"
          size={500}
        />
      </section>
      ...
      <section className="py-24 max-w-7xl mx-auto px-6 grid md:grid-cols-2 lg:grid-cols-4 gap-8">
        {facilities.map((f, i) => (
          <div
            key={i}
            className="p-10 border border-slate-100 rounded-[3rem] hover:bg-slate-50 transition-all"
          >
